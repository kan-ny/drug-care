        ...
        <Card sm={{ maxWidth: 750 }}>
            <div >
                <CardContent >
                    ...
                    <CardMedia component="img" alt="green iguana" display = "block" max-width = "100%" height = 'auto' image={img} src="picture" />
                    <Typography style={{ margin: '10px' }} gutterBottom variant="h5" component="div"> Find the treatment you need </Typography>

                    <CardActions> <Button onClick={toggle_} variant="contained" size="small">Register here</Button> </CardActions>
                    ...
                    <Typography align='left' variant="subtitle1" color="text.secondary">
                        Agencies interested in listing their services can contact admin@drughelp.care. </Typography>
